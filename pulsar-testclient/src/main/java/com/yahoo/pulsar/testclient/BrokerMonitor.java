...
public class BrokerMonitor {
    ...
    private static class LoadReportWatcher implements Watcher {
        ...
        public synchronized void printLoadReport(final String path) {
            ...
            System.out.println(String.format("\nRaw CPU: %.2f%%", resourceUsage.getCpu().percentUsage()));
            ...
            System.out.println(String.format("\nRaw Memory: %.2f%%", resourceUsage.getMemory().percentUsage()));
            ...
            System.out.println(String.format("\nRaw Bandwidth In: %.2f%%", resourceUsage.getBandwidthIn().percentUsage()));
            ...
            System.out.println(String.format("\nRaw Bandwidth Out: %.2f%%", resourceUsage.getBandwidthOut().percentUsage()));
            ...
            System.out.println(String.format("\nDirect Memory: %.2f%%", resourceUsage.getDirectMemory().percentUsage()));

            System.out.println(String.format("Messages In Per Second: %.2f", loadReport.getMsgRateIn()));
            System.out.println(String.format("Messages Out Per Second: %.2f", loadReport.getMsgRateOut()));
            System.out.println(String.format("Preallocated Messages In Per Second: %.2f", loadReport.getPreAllocatedMsgRateIn()));
            System.out.println(String.format("Preallocated Out Per Second: %.2f", loadReport.getPreAllocatedMsgRateOut()));
            System.out.println();
